  ...
  const registerForm = (e) => {
    ...
    fetch('http://localhost:5000/Admin/adduser', {
      ...
      .then((result) => {
        console.log(result);
        if (result === "success") {
          setMessage('Team lead added successfully.');
          setTimeout(() => {
            ...
            <div className="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-6 ">
              <div className="rounded p-4 p-sm-5 my-4 mx-3">
                <div className="d-flex align-items-center justify-content-between mb-3">
                  <h3 className="text-primary">Add Team Leader</h3>
                </div>
                ...
                {message && <div className={`alert ${message === 'Team Leader added successfully.' ? 'alert-success' : 'alert-danger'}`}>{message}</div>}
              </div>
            </div>
          </div>
        </div>
